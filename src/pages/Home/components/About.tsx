                ...
                <div className="grid md:grid-cols-2 gap-6 justify-center items-start">
                    ...
                    <div className="px-4 md-px-0">
                        <p className="leading-7 md:pt-0 text-lg tracking-wide">
                            I specialized <span className="font-semibold">Computer Engineering & Information Technology</span> at <span className="italic">Mandalay Technological University </span>
                            ...
                            After one year & 2 months, I joined <span className="font-semibold">Visible One HK</span> and currently I'm working as Web Developer specializing in <span className="font-semibold">PHP/Laravel Backend Development</span>.
                        </p>
                    </div>
                </div>
            </div>
